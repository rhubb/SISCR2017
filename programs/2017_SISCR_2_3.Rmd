...
2. Next, let's use Bayesian logistic regression to analyze the association between COPD and predictors cigarette type, nicotine content, and filter, using relatively flat priors centered at 0.

```{r, eval = TRUE}
## -- Normal priors for regression coefficients (with mean=0 and scale=10)
copd.glm1 <- bayesglm(copd ~ TYPE + NIC + TAR, data=copd, family=binomial, prior.mean=0, 
