...
### Install R Packages
- For this module we will be using the _INLA_ and _rjags_ packages for Bayesian estimation
- We will also be using the _eha_ and _survival_ packages for survival regression
...
3. Using one of the models you fit in (2) interpret your results. What do you conclude about the association between behavioral pattern and CHD? Does your choice of prior affect   
